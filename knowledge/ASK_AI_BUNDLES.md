...
Organized packages synced to GitHub `smart-support-bot` and VPS `/opt/blackfox-agent-bot`.
...
## 04 — Service unit
- `deploy/blackfox-agent-bot.service`
- WorkingDirectory `/opt/blackfox-agent-bot`
