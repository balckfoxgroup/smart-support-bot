...
async def _heartbeat_loop() -> None:
    ...
    while True:
        try:
            ...
            logging.getLogger("blackfox-agent-bot").exception("heartbeat write failed")
...
async def _register_bot_commands(bot: Bot, settings: Settings) -> None:
    ...
    for admin_id in settings.bot_admin_ids:
        try:
            ...
            logging.getLogger("blackfox-agent-bot").warning(
...
async def run() -> None:
    ...
    log = logging.getLogger("blackfox-agent-bot")
